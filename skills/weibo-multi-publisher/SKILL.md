...
发文前如果用户提到“tag 打满”“带话题”，默认按闭合 hashtag 格式整理后再发。
...
python3 scripts/post_text_weibo.py --state skills/weibo-multi-publisher/storage-state/gengwanbu.json --text "测试一下自动发微博功能，别理我。"
python3 scripts/post_video_weibo.py --state skills/weibo-multi-publisher/storage-state/gengwanbu.json --text "原神也有男通讯录，自带汉化！ #原神 #男通讯录 #汉化 #游戏 #二创" --video /path/demo.mp4
```
